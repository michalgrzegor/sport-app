...
const routes: Routes = [
    ...
    { path: 'chat', component: ChatComponent, canActivate: [PaidGuard]},
    ...
    { path: 'calendar', loadChildren: './callendar-simple/callendar.module#CalendarModule', canActivate: [GuardGuard] },
